...
function Design() {
    return (
        <div className="bg-[#EFECE7] mt-8 py-20">
            <h1 className="text-center text-5xl">Design Machines, Not CAD Files.</h1>

            <div className="grid grid-cols-3 gap-4 px-16 mt-20 text-center">
            ...
            <div className="grid grid-cols-2 mt-18 px-16">
                <div>
                    <h1 className="text-[64px] text-[#ff661f]">Our Capabilities</h1>
                </div>
                <div>
                    <Accordion />
                </div>
